# GymSwift 🏋
Projeto desenvolvido em Swift durante um mini curso de Programação Orientada a Objetos.
...
- Manutenção programada de equipamentos
- Criação de turmas coletivas
